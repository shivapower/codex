...
pub(crate) struct GeneratedHookSchemas {
    ...
    pub user_instructions_command_input: Value,
...
pub(crate) fn generated_hook_schemas() -> &'static GeneratedHookSchemas {
    ...
    SCHEMAS.get_or_init(|| GeneratedHookSchemas {
        ...
        user_instructions_command_input: parse_json_schema(
            "user-instructions.command.input",
...
mod tests {
    ...
    fn loads_generated_hook_schemas() {
        ...
        assert_eq!(schemas.user_instructions_command_input["type"], "object");
