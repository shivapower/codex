...
pub(crate) static AUTOMATIONS_MIGRATOR: Migrator = sqlx::migrate!("./automations_migrations");
...
pub(crate) fn runtime_automations_migrator() -> Migrator {
    runtime_migrator(&AUTOMATIONS_MIGRATOR)
}
